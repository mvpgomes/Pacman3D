...
pacman::BMPloader::BMPloader( const string filename)
{
	mImage = NULL;
	mWidth = mHeight = 0;
	mIsOK  = false;
...
const unsigned int pacman::BMPloader::getShort()
{
	char ch1, ch2;
...
const unsigned int pacman::BMPloader::getLong()
{
